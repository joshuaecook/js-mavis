 ...
 * @param obj An object.
 *
 * @discussion An object may be considered callable if it is not <var>undefined</var> 
 * and is an instance of <var>Function</var>.
 *
 * @return A boolean value.  <var>true</var> if the given object appears callable, <var>false</var> otherwise.
 */
...
/*! @function match
 * @abstract Creates an adapter from a selection of predicates and bridges.
 */
...
/*! @function cmp
 * @abstract Compares two objects.
 *
 * @return A negative integer if <var>x</var> is less than <var>y</var>,
 * zero if <var>x</var> and <var>y</var> are equal, 
 * or a positive integer if <var>x</var> is greater than <var>y</var>.
 */
...
/*! @function range
 * @abstract Creates an arithmetic progression.
 *
...
/*! @function list
 * @abstract Creates a new sequence.
 * @param sequence An iterable sequence.
 *
 * If no argument is given, an empty sequence is returned.
 *
 * The given argument may be any object that supports iteration, including a string,
 * an Array or Array-like object, an iterator, or an object that can provide an
 * iterator.
 *
 * @throws TypeError if a single parameter is given and the object does not support iteration.
 *
